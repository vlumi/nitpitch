...
- Watch: the front door shows your starred instruments only — the whole
  ...
  favorites in their place among them. Starred rows wear their star
  everywhere, so both lists explain themselves. Starring works from the
  wrist now too: swipe any instrument row, or use the new Favorite
  toggle on its detail screen — and it syncs, so a star given on the
  watch shines on the phone's launch screen.
