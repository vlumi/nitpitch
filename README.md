...
- **A tuner on the wrist.** The Apple Watch app tunes with its own microphone and speaks in haptics: taps at the string's real beat rate against its target — up for flat, down for sharp, silence when true — so tuning never needs eyes. Ships inside the iPhone app and stands alone in the watch's App Store; setups arrive over iCloud sync.
